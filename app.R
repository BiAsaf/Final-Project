...
ui <- fluidPage(theme = shinytheme("yeti"),navbarPage("Reveals The Scams",
                ...
                tabPanel("About",
                         titlePanel("About"),
                         div(includeMarkdown("C:/Users/Asaf's/Desktop/Final_Project/about.rmd")),
                         icon = icon("fa-solid fa-info")),
                tabPanel("Contact Us",
                         titlePanel("Contact Us"),
                         div(includeMarkdown("C:/Users/Asaf's/Desktop/Final_Project/ContactUs.rmd")),
...
server <- function(input, output,session) {
    ...
    output$imageOutput <- renderImage ({
        list(src = "C:/Users/Asaf's/Desktop/Final_Project/auction1.jpg",
    ...
    output$outputTxt <- renderText({
        ...
        if(counter == 4 && input$submitbutton>0){
            output$imageOutput <- renderImage ({
                list(src = "C:/Users/Asaf's/Desktop/Final_Project/approved.jpg",
        ...
        if(counter != 4 && input$submitbutton>0){
            output$imageOutput <- renderImage ({
                list(src = "C:/Users/Asaf's/Desktop/Final_Project/rejected.jpg",
